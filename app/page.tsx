...
export default function Home() {
  ...
  // Use the max length to sync both sections
  const maxHeadings = Math.max(firstHeadings.length, secondHeadings.length);
  const [activeIndex, setActiveIndex] = useState(0);

  useEffect(() => {
    const interval = setInterval(() => {
      setActiveIndex((prev) => (prev + 1) % maxHeadings);
    }, 2000);
          ...
          <div className="row">
            ...
            <div className="statistics__wrapper">
              ...
              <div className="statistics__content--header statistics__content--header-second">
                {secondHeadings.map((heading, idx) => (
                  <div
                    key={heading}
                    className={
                      "statistics__heading" +
